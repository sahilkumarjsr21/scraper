...
class PrivateBankScrapyInsights(CrawlSpider):
    ...
    rules = (
        Rule(LinkExtractor(allow=[r"/gl/en/people.+", r"https://privatebank.jpmorgan.com/gl/en/people.+"]), callback="parse_services_data", follow= True),
    )
    ...
    def parse_services_data(self, response):
        ...
        selectors = ['h1[class*="jpm-wm-promotional-people-detail-hero__name"]', 'span[class*="jpm-wm-promotional-people-detail-hero__title-detail"]', 'section[class*="jpm-wm-promotional-people-detail-hero__bodycopy"]']
        str = ""
